...
public static class FeatureRequestPortalEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE FeatureRequestPortalModuleExtensionConfigurator CLASS (in the Domain.Shared project)
